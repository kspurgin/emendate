...
[source, ruby]
----
ex = Examples::ExampleSet.new
 => Examples::ExampleSet: 204 examples from 248 rows (data_sets: , date_types: )
----
...
[source, ruby]
----
ex = Examples::ExampleSet.new(date_types: 'approximate')
 => Examples::ExampleSet: 41 examples from 47 rows (data_sets: , date_types: approximate)
----

.Examples from the `ba` dataset
[source, ruby]
----
ex = Examples::ExampleSet.new(data_sets: 'ba')
 => Examples::ExampleSet: 38 examples from 45 rows (data_sets: ba, date_types: )
----

.Examples from the `ba` dataset expressing decades
[source, ruby]
----
ex = Examples::ExampleSet.new(data_sets: 'ba', date_types: 'decades')
 => Examples::ExampleSet: 4 examples from 6 rows (data_sets: ba, date_types: decades)
----
...
[source, ruby]
----
ex = Examples::ExampleSet.new(data_sets: 'ba;ncm')
 => Examples::ExampleSet: 1 examples from 1 rows (data_sets: ba;ncm, date_types: )
----
