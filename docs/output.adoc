...
For this use case, you can call `translate` (with `target_dialect` option set), and you will receive an `Emendate::Translation` object with the following attributes:
