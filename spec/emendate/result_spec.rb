...
RSpec.describe Emendate::Result do
  ...
  describe '#to_h' do
    it 'returns hash' do
      res = Emendate.parse('mid 1800s to 2/23/1921').to_h
  ...
  describe '#to_json' do
    it 'returns JSON escaped string' do
      res = Emendate.parse('mid 1800s to 2/23/1921').to_json
      expected = <<~LONGSTRING
      {\"original_string\":\"mid 1800s to 2/23/1921\",\"dates\":[{\"original_string\":\"mid 1800s to 2/23/1921\",\"index_dates\":[],\"date_start\":null,\"date_end\":null,\"date_start_full\":\"1804-01-01\",\"date_end_full\":\"1921-02-23\",\"inclusive_range\":true,\"certainty\":[]}],\"errors\":[],\"warnings\":[\"Interpreting pluralized year as decade\"]}
      LONGSTRING
